...
static const uint8 g_scoreNotes[] = {
    5, 6, 7, 8, 7, 6, 5, 4,  // G A B 高音C B A G F
    3, 4, 5, 6, 5, 4, 3, 2,  // E F G A G F E D
    1, 3, 5, 6, 7, 6, 5, 3,  // C E G A B A G E
    4, 6, 8, 7, 5, 4, 3, 1   // F A 高音C B G F E C
};

static const uint8 g_scoreDurations[] = {
    1, 1, 1, 2, 1, 1, 1, 2,  // 每个音符的时长更短，保持快节奏
    1, 1, 1, 2, 1, 1, 1, 2,
    1, 1, 1, 2, 1, 1, 1, 2,
    1, 1, 1, 2, 1, 1, 1, 2
};
